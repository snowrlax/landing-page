...
export const Timeline = () => {
    return (
        <div className="mt-8 px-20">
            ...
            <p className="text-center mt-3">We're here to support you through all stages of the university journey; whether its researching institutions, navigating admissions or submitting your application.</p>
            <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical mt-6 px-10">
                <li>
                    ...
                    <div className="timeline-start md:text-end mb-10">
                        ...
                        <figure><Image width={64} height={64} className="rounded-full w-44 h-44 image-fit object-cover" src="/landingCardImg.webp" alt="" /></figure>
                    </div>
                ...
                <li>
                    ...
                    <div className="timeline-start md:text-end m-20 ">
